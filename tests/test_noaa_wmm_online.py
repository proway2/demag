...
class TestWMMOnline(unittest.TestCase):
    ...
    def test_N0_W45(self):
        ...
        self.assertAlmostEqual(
            self.md_object.md(lon=-45.0, lat=0.0, year=2015, mon=10, day=15),
            -20.313,
            delta=0.01,
        )
    ...
    def test_N0_W180(self):
        ...
        self.assertAlmostEqual(
            self.md_object.md(lon=-180.0, lat=0.0, year=2015, mon=10, day=15),
            9.58,
            delta=0.01,
        )
    ...
    def test_N0_E90(self):
        ...
        self.assertAlmostEqual(
            self.md_object.md(lon=90.0, lat=0.0, year=2015, mon=10, day=15),
            -2.03,
            delta=0.01,
        )
    ...
    def test_N45_E0(self):
        ...
        self.assertAlmostEqual(
            self.md_object.md(lon=0.0, lat=45.0, year=2015, mon=10, day=15),
            -0.14,
            delta=0.01,
        )
    ...
    def test_N90_E0(self):
        ...
        self.assertAlmostEqual(
            self.md_object.md(lon=0.0, lat=90.0, year=2015, mon=10, day=15),
            -4.80,
            delta=0.01,
        )
    ...
    def test_N45_E90(self):
        ...
        self.assertAlmostEqual(
            self.md_object.md(lon=90.0, lat=45.0, year=2015, mon=10, day=15),
            2.38,
            delta=0.01,
        )
